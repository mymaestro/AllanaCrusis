        ...
        <div class="row g-4 py-4 row-cols-1 row-cols-lg-3">
            ...
            <div class="feature col">
                <div class="card h-100 border-secondary">
                    <div class="card-body">
                        ...
                        <a href="./compositions" aria-label="Go to compositions" class="text-decoration-none text-body-emphasis">
            ...
            <div class="feature col">
                <div class="card h-100 border-secondary">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <a href="./parts" aria-label="Go to parts" class="text-decoration-none text-body-emphasis">
            ...
            <div class="feature col">
                <div class="card h-100 border-secondary">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <a href="./playgrams" aria-label="Go to playgrams" class="text-decoration-none text-body-emphasis">
        ...
        <div class="row g-4 py-4 row-cols-1 row-cols-lg-2">
            ...
            <div class="feature col">
                <div class="card h-100 border-secondary">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <a href="./concerts" aria-label="Go to concerts" class="text-decoration-none text-body-emphasis">
            ...
            <div class="feature col">
                <div class="card h-100 border-secondary">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <a href="./recordings" aria-label="Go to recordings" class="text-decoration-none text-body-emphasis">
        ...
        <div class="row g-3 py-4">
            <div class="col-md-2">
                <div class="card border-secondary h-100">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <a href="./instruments" aria-label="Go to instruments" class="text-decoration-none text-body-emphasis">
            ...
            <div class="col-md-2">
                <div class="card border-secondary h-100">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <a href="./parttypes" aria-label="Go to part types" class="text-decoration-none text-body-emphasis">
            ...
            <div class="col-md-2">
                <div class="card border-secondary h-100">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <a href="./ensembles" aria-label="Go to ensembles" class="text-decoration-none text-body-emphasis">
            ...
            <div class="col-md-2">
                <div class="card border-secondary h-100">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <a href="./genres" aria-label="Go to genres" class="text-decoration-none text-body-emphasis">
            ...
            <div class="col-md-2">
                <div class="card border-secondary h-100">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <a href="./partcollections" aria-label="Go to part collections" class="text-decoration-none text-body-emphasis">
            ...
            <div class="col-md-2">
                <div class="card border-secondary h-100">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <a href="./papersizes" aria-label="Go to paper sizes" class="text-decoration-none text-body-emphasis">
